...
class Member_Order_accessories extends Component {
    constructor(props) {
        super(props)
        this.state = {
            error: null,
    ...
    componentDidMount() {
        ...
        console.log(sid)
        const url = 'http://localhost:3000/order_list_detail_accessories/' + sid
...
export default Member_Order_accessories;